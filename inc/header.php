        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark p-4">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item <?= $path == 'index.php' ? 'active' : '' ?>">
                        <a class="nav-link font-weight-bold" href="index.php">Home</a>
                    </li>
                    <li class="nav-item ml-2 <?= $path == 'mens.php' ? 'active' : '' ?>">
                        <a class="nav-link font-weight-bold" href="mens.php">Mens</a>
                    </li>
                    <li class="nav-item ml-2 <?= $path == 'women.php' ? 'active' : '' ?>">
                        <a class="nav-link font-weight-bold" href="women.php">Womens</a>
                    </li>
                    <li class="nav-item ml-2 <?= $path == 'kids.php' ? 'active' : '' ?>">
